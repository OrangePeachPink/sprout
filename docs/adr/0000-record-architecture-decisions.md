...
| [0014](0014-operator-control-plane.md) | Operator control plane (Monitor + Experiment under one plane; extends ADR-0011) | **Accepted** — maintainer-ratified 2026-07-03 (Trellis digest #465); Operator-Experience epic #125 all-slices-shipped; §5 `serve.py` boundary explicit (#296) | Data lane |
...
| [0021](0021-parse-v1-telemetry-contract-boundary.md) | parse_v1 is the single telemetry contract boundary (extends ADR-0006) | **Accepted** — maintainer-ratified 2026-07-03 (Trellis digest #433); drafted by Trellis, Data-confirmed 2026-06-30 (#294/#295 landed; boundary verified — header bounds authoritative, `DEFAULT_CAL_BOUNDS` a labelled fallback, value=NULL honored) | Trellis (author) + Data lane |
