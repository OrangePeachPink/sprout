...
> **Archived v0 record — Superseded by [ADR-0001](../0001-architecture-and-control-loop.md).**
> This is the project's original combined architecture/scope record, written for the single-board
> prototype, and is **preserved here unchanged as history.** The `Status: Accepted` line below reflects
> its original v0 state; the current architecture decision is **ADR-0001**. Do not edit this file —
