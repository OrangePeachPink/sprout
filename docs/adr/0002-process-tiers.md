...
| **18** | Design system | Design tokens (color/type/space/radius) as CSS custom properties + a small component set — ratified in [ADR-0004](0004-design-system.md) | ✅ Design | 📋 **already built** — v1 + v2 under `docs/design/` |
